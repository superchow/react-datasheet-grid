...
const CheckboxComponent = React.memo<CellProps<boolean, any, any>>(
  ({ focus, cellData, setCellData, active, stopEditing }) => {
    ...
    return (
      <input
        ...
        onMouseDown={() => !active && setCellData(!cellData)}
        onChange={() => null}
      />
    )
  }
...
export const checkboxColumn: Partial<Column<boolean, any, string>> = {
  component: CheckboxComponent as unknown as CellComponent<boolean, any, any>,
  width: '0 0 40px',
  minWidth: 40,
  maxWidth: 100,
  deleteValue: () => false,
